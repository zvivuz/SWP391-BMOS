...
public class MealDAO {
    ...
    public boolean createMeal(String quantity, String meal_package_id, String product_id) {
        try {
            String sql = "INSERT INTO tbl_Meal ([quantity], [meal_package_id], [product_id])\n"
                    + "VALUES (?, ?, ?)";
            PreparedStatement stm = db.getConnection().prepareStatement(sql);
            stm.setString(1, quantity);
            stm.setString(2, meal_package_id);
    ...
    public void updateMeal(String quantity, String meal_package_id, String product_id) {
    ...
    public Meal getMealById(String meal_package_id) {
//        String sql = "select * from tbl_Product where product_id=?";
        try {
            String sql = "select * from tbl_Meal where meal_package_id=?";
            cn = (Connection) DBUtils.getConnection();
            stm = cn.prepareStatement(sql);
            stm.setString(1, meal_package_id);
            rs = stm.executeQuery();
    ...
    public List<Meal> getListByPage(List<Meal> list, int start, int end) {
        ArrayList<Meal> arr = new ArrayList<>();
