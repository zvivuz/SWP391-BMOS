...
public class DTO {
    ...
    public DTO(int product_id, String product_code, String title, int quantity, int price, int discount_price, float weight, String thumbnail, String description, Date create_at, Date update_at, boolean status, int category_id, int bird_id) {
