 ...
 * @author Thắng
 */
@WebServlet(name="AdminViewMealController", urlPatterns={"/AdminViewMealController"})
public class AdminViewMealController extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       HttpSession session = request.getSession();
        session.setAttribute("meal", list_package);
