<%-- 
    Document   : order-staff-page
    Created on : Jul 4, 2023, 10:25:53 PM
    Author     : 09047
--%>
                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>Hello, <span>Welcome Staff</span></h1>
                                </div>
                            </div>
                        </div>
                        <!-- /# column -->
                    ...
                    <section id="main-content">
                                ...
                                <tbody>
                                    <c:forEach items="${Order}" var="x">
                                        <tr>
                                            ...
                                            <td style="text-align: left;">${x.order_id}</td>
                                            <td style="text-align: left;">${x.order_date}</td>
                                            <td style="text-align: left;">${x.totalmoney}</td>
                                            <td style="text-align: left;">
                                                <span style="background-color: yellow; padding: 2px 4px;">
                                                    Unconfirm
                                                </span>
                                                <span style="display: none;">${x.status}</span>
                                            </td>
                                            <td class="text-center">
                                                <form action="DispatchServlet" method="POST">
                                                    <input type="hidden" name="id" value="${x.order_id}">
                                                    <input type="submit" name="action" value="Confirm" style="background-color: #00ced1; color: white;">
                                                </form>
                                            </td>
                                        </tr>
                                    </c:forEach>
                        ...
                        <div class="product__pagination" align="center">
                            <c:forEach begin="${1}" end="${sessionScope.num}" var="i">
                                <a href="ViewOrderStaffPageController?ppage=${i}">${i}</a>                  
                            </c:forEach>
