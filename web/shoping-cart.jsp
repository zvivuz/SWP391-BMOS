                    ...
                    <div class="shoping__cart__table">
                        <table>
                            ...
                            <tbody>
                                ...
                                <c:set var="total" value="${total + o.product.price* o.amount}"/>                                                
                                <tr>
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                <input type="text" value="${o.amount}">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="shoping__cart__total">
                                        ${o.product.price*o.amount}đ
                                    </td>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="ViewShopPageController" class="primary-btn cart-btn">CONTINUE SHOPPING</a>
