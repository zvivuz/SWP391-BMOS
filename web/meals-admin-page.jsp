                    ...
                    <section id="main-content">
                        ...
                        <div class="table-responsive-lg">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <c:forEach items="${list_package}" var="x">
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" class="btn btn-primary btn-sm" title="Update" data-toggle="modal" data-target="#createProductModal1"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group" style="font-weight: bold; text-align: left; display: block;">
                                                ...
                                                <input type="text" class="form-control" id="productTitle" placeholder="Enter title">
                                            </div>
                                            <div class="form-group" style="font-weight: bold; text-align: left; display: block;">
                                                <label for="productTitle">Price</label>
                                                <input type="text" class="form-control" id="productTitle" placeholder="Enter price">
                                            </div>
                                            <div class="form-group" style="font-weight: bold; text-align: left; display: block;">
                                                <label for="productTitle">Discount Price</label>
                                                <input type="text" class="form-control" id="productTitle" placeholder="Enter discount price">
                                            </div>
                                            <div class="form-group" style="font-weight: bold; text-align: left; display: block;">
                                                <label for="productTitle">Thumbnail</label>
                                                <input type="text" class="form-control" id="productTitle" placeholder="Enter thumbnail">
                                            </div>
                                            <div class="form-group" style="font-weight: bold; text-align: left; display: block;"> 
                                                <label for="productPrice">List Product</label>
                                                <input type="text" class="form-control" id="productTitle" placeholder="Enter List">
                                            </div>
